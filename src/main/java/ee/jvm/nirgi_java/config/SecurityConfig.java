    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/model-list/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_TECHNOLOGIST", "ROLE_MANAGER")
                        .requestMatchers("/api/section-lists/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_TECHNOLOGIST", "ROLE_MANAGER")
                        .requestMatchers("/api/techmaps/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_TECHNOLOGIST", "ROLE_MANAGER")
                        .requestMatchers("/api/orders/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_MASTER", "ROLE_TECHNOLOGIST", "ROLE_MANAGER")
                        .requestMatchers("/api/dubl-orders/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_MASTER", "ROLE_TECHNOLOGIST", "ROLE_MANAGER")
