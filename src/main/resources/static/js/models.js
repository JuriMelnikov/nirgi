document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateTechmapsTable(techmaps) {
        ...
        techmaps.forEach(techmap => {
            ...
            row.innerHTML = `
                <td class="text-sm text-center" style="padding: 0px 4px; height: 25px; border: 1px solid #e5e7eb; width: 40px;">${techmap.serial}</td>
                <td class="text-sm text-left" style="padding: 0px 4px; height: 25px; border: 1px solid #e5e7eb;">${techmap.descriptor}</td>
                <td class="text-sm text-left" style="padding: 0px 4px; height: 25px; border: 1px solid #e5e7eb; width: 80px;">${techmap.time}</td>
                <td class="text-sm text-left" style="padding: 0px 4px; height: 25px; border: 1px solid #e5e7eb; width: 80px;">${formatPrice(techmap.price)}</td>
                <td class="text-sm text-left" style="padding: 0px 4px; height: 25px; border: 1px solid #e5e7eb; width: 80px;">
